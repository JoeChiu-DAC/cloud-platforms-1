...
sub mailer { 
	my $c = shift;
	my $csv = 'https://github.com/NSWDAC/Platform/tree/master/Operations/Certificate%20Expiry%20Check/jenkins-ssl-exp';
	$c .= "<ul style='margin-left:-20;'>Script's available in GitHub: <a href='$csv'>$csv</a></ul>";
